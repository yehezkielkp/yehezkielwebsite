...
export default function BlogCategoryArea({ slug, setIsVideoOpen, setVideoId }: IProps) {
  // Convert slug to category format (e.g., "ui-ux-design" -> "UI/UX Design")
  const category = slug
    .split("-")
  ...
  const blog_items = [...blog_classic.filter((b) => !b.blogHeroSlider && b.category?.toLowerCase() === category.toLowerCase())];
