...
export default function BlogClassicSlider() {
  const slider_blog_data = [...blog_classic.filter((b) => b.blogHeroSlider)].slice(0, 3);
        ...
        >
          {slider_blog_data.map((item) => (
            <SwiperSlide key={item.id}>
              <div className="blog-sidebar-slider-bg blog-sidebar-slider-height d-flex align-items-center pt-170 pb-120 p-relative" style={{ minHeight: '700px', overflow: 'hidden' }}>
