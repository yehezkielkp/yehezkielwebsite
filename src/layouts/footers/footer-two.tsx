            ...
            <div className="col-xl-3 col-lg-5 col-md-6 mb-50">
              <div className="tp-footer-2-widget footer-col-2-3">
                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <a
                      href="https://www.google.com/maps/@-8.6705,115.2126,15z?entry=ttu"
                      target="_blank"
                    >
                      Jl. Lumba-Lumba, Perumahan Puri Candra Asri Blok A No. 24, Denpasar Timur, Kota Denpasar, Bali, Indonesia 80237
                    </a>
                  </span>
                </div>
                <div className="tp-footer-2-contact-item">
                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <a href="mailto:info@ourastudios.com">E: info@ourastudios.com</a>
                  </span>
                </div>
              </div>
            </div>
